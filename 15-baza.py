...
#### AND #####
# cursor.execute("SELECT * FROM korisnici WHERE ime LIKE '%s%' AND godine = 18")
# rezultat = cursor.fetchall()
# for red in rezultat:
#     print(red)

#### OR #####
# cursor.execute("SELECT * FROM korisnici WHERE ime LIKE '%s%' OR godine = 18")
# rezultat = cursor.fetchall()
# for red in rezultat:
#     print(red)

#### UPDATE #####
# izmena = "UPDATE korisnici SET godine = 17 WHERE id = 3"
# cursor.execute(izmena)
# baza.commit()

#### LIMIT #####
# cursor.execute("SELECT * FROM korisnici LIMIT 3")
# cursor.execute("SELECT * FROM korisnici LIMIT 3 OFFSET 1")
...
#### DELETE #####
# brisanje = "DELETE FROM korisnici WHERE id = 4"
